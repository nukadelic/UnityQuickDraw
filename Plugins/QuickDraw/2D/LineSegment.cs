...
namespace QuickDraw
{
	public static class LineSegment
	{
		...
		static Material GetLineMaterial(Info lineInfo)
		{
			int materialIndex = 0;
		...
		static Mesh GetLineMesh(Info lineInfo)
		{
		...
		static MaterialPropertyBlock GetMaterialPropertyBlock(Info lineInfo)
		{
		...
		static void FillPropertyBlock(MaterialPropertyBlock block, Info lineInfo,float lineSegmentLength)
		{
			block.SetColor(_colorParam,lineInfo.fillColor);
			block.SetFloat(_antiAliasingSmoothingParam, Common.AASmoothing );
		...
		public static void Draw(Info lineInfo)
		{
