...
namespace QuickDraw
{
	public class Polygon
	{
		...
		static Mesh GenerateMeshPolygon(Info polygonInfo)
		{
		...
		static MaterialPropertyBlock GetMaterialPropertyBlock(Info polygonInfo)
		{
		...
		static Material GetMaterial(Info polygonInfo)
		{
		...
		public static void Draw(Info polygonInfo)
		{
